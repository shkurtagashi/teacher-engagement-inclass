...
/**
 * Created by shkurtagashi on 07.02.17.
 */
...
//        testESMTrigger(context);
    ...
    private void testSchedueldPam(Context c) {
//        try {
//
...
//
//            Scheduler.Schedule pam_schedule = new Scheduler.Schedule("pam");
//            pam_schedule
//                    .addHour(17)
//                    .addMinute(48)
//                    .setInterval(1)
...
//                    .addActionExtra(ESM.EXTRA_ESM, esmPAM.build());
//
//            Scheduler.saveSchedule(c, pam_schedule);
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
    }
