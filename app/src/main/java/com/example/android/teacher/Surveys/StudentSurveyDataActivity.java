...
public class StudentSurveyDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_survey_data);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.add_account:
                if(dbHelper.getUsersCount() < 1) {
                    ...
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(StudentSurveyDataActivity.this);
            ...
            case R.id.delete_account:
                AlertDialog.Builder builder = new AlertDialog.Builder(StudentSurveyDataActivity.this);
